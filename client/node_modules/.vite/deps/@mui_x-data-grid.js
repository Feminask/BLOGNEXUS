...
import {
  ...
  init_extends,
  require_prop_types
} from "./chunk-BJIGXFFS.js";
import "./chunk-ZGXLSBKF.js";
import {
  require_react_dom
...
var _excluded47 = ["className", "rowCount", "visibleRowCount"];
...
var _excluded48 = ["selected", "rowId", "row", "index", "style", "rowHeight", "className", "visibleColumns", "pinnedColumns", "offsetTop", "offsetLeft", "dimensions", "renderContext", "focusedColumnIndex", "isFirstVisible", "isLastVisible", "isNotVisible", "focusedCell", "tabbableCell", "onClick", "onDoubleClick", "onMouseEnter", "onMouseLeave", "onMouseOut", "onMouseOver"];
...
var useGridRows = (apiRef, props) => {
  ...
  const updateServerRows = React128.useCallback((updates, groupKeys) => {
    const nonPinnedRowsUpdates = computeRowsUpdates(apiRef, updates, props.getRowId);
    const cache2 = updateCacheWithNewRows({
      updates: nonPinnedRowsUpdates,
      getRowId: props.getRowId,
  ...
  const setLoading = React128.useCallback((loading) => {
...
var _excluded52 = ["className", "visibleColumns", "sortColumnLookup", "filterColumnLookup", "columnHeaderTabIndexState", "columnGroupHeaderTabIndexState", "columnHeaderFocus", "columnGroupHeaderFocus", "headerGroupingMaxDepth", "columnMenuState", "columnVisibility", "columnGroupsHeaderStructure", "hasOtherElementInTabSequence"];
...
var _excluded54 = ["native"];
function MUISelectOption(_ref) {
  let {
    native
  } = _ref, props = _objectWithoutPropertiesLoose(_ref, _excluded54);
  if (native) {
...
// node_modules/@mui/x-data-grid/hooks/features/columnGrouping/useGridColumnGrouping.js
var _excluded55 = ["groupId", "children"];
var createGroupLookup = (columnGroupingModel) => {
  ...
  columnGroupingModel.forEach((node) => {
    ...
    const {
      groupId,
      children
    } = node, other = _objectWithoutPropertiesLoose(node, _excluded55);
    if (!groupId) {
