...
var processChildren = (children, outline, pill) => {
  return import_react5.Children.map(children, (child, index2) => {
    if ((0, import_react5.isValidElement)(child)) {
      const positionInGroupProp = child.type == Button ? { positionInGroup: determinePosition(index2, import_react5.Children.count(children)) } : {};
...
// node_modules/flowbite-react/dist/esm/components/Clipboard/ClipboardWithIcon.mjs
var ClipboardWithIcon = (0, import_react16.forwardRef)(
...
var ClipboardWithIconText = (0, import_react17.forwardRef)(
...
// node_modules/flowbite-react/dist/esm/components/Clipboard/Clipboard.mjs
var ClipboardComponent = (0, import_react18.forwardRef)(
...
var useThemeMode = () => {
  const [mode, setMode] = (0, import_react21.useState)(getInitialMode(getThemeMode()));
...
var DatepickerContext = (0, import_react23.createContext)(void 0);
function useDatePickerContext() {
  const context = (0, import_react23.useContext)(DatepickerContext);
  if (!context) {
...
var DatepickerRender = ({
  ...
  const [isOpen, setIsOpen] = (0, import_react24.useState)(open);
  const [view, setView] = (0, import_react24.useState)(Views.Days);
  const [selectedDate, setSelectedDate] = (0, import_react24.useState)(defaultDate);
  const [viewDate, setViewDate] = (0, import_react24.useState)(defaultDate);
  const inputRef = (0, import_react24.useRef)(null);
  const datepickerRef = (0, import_react24.useRef)(null);
...
var Datepicker = (0, import_react24.forwardRef)(DatepickerRender);
...
var DrawerContext = (0, import_react25.createContext)(void 0);
function useDrawerContext() {
  const context = (0, import_react25.useContext)(DrawerContext);
  if (!context) {
...
var DropdownContext = (0, import_react28.createContext)(void 0);
function useDropdownContext() {
  const context = (0, import_react28.useContext)(DropdownContext);
  if (!context) {
...
var DropdownItem = (0, import_react30.forwardRef)(
...
var Trigger = ({
  ...
  if (renderTrigger) {
    ...
    return (0, import_react32.cloneElement)(triggerElement, { ref: refs.setReference, disabled, ...a11yProps, ...triggerElement.props });
  }
...
var DropdownComponent = ({
  ...
  const [selectedIndex, setSelectedIndex] = (0, import_react32.useState)(null);
  const [buttonWidth, setButtonWidth] = (0, import_react32.useState)(void 0);
  const elementsRef = (0, import_react32.useRef)([]);
  const labelsRef = (0, import_react32.useRef)([]);
  ...
  const handleSelect = (0, import_react32.useCallback)((index2) => {
    setSelectedIndex(index2);
    setOpen(false);
  }, []);
  const handleTypeaheadMatch = (0, import_react32.useCallback)(
    (index2) => {
      if (open) {
  ...
  const Icon = (0, import_react32.useMemo)(() => {
...
var FileInput = (0, import_react33.forwardRef)(
...
var FloatingLabel = (0, import_react34.forwardRef)(
  ({
    label,
    helperText,
    color = "default",
    ...
    const randomId = (0, import_react34.useId)();
...
var HRIcon = (0, import_react35.forwardRef)(
...
var HRSquare = (0, import_react36.forwardRef)(
...
var HRText = (0, import_react37.forwardRef)(
...
var HRTrimmed = (0, import_react38.forwardRef)(
  ({ theme: customTheme = {}, className, ...props }, ref) => {
...
// node_modules/flowbite-react/dist/esm/components/HR/HR.mjs
var HRComponent = (0, import_react39.forwardRef)(({ theme: customTheme = {}, className, ...props }, ref) => {
...
var NavbarContext = (0, import_react40.createContext)(void 0);
function useNavbarContext() {
  const context = (0, import_react40.useContext)(NavbarContext);
  if (!context) {
...
var NavbarComponent = ({
  ...
  const [isOpen, setIsOpen] = (0, import_react41.useState)(menuOpen);
...
var MegaMenuDropdown = ({
  ...
  const [labelledBy, setLabelledBy] = (0, import_react42.useState)(void 0);
...
var MegaMenuDropdownToggle = ({
  ...
  const [controls, setControls] = (0, import_react43.useState)(void 0);
  const [isExpanded, setExpanded] = (0, import_react43.useState)(void 0);
...
var ModalContext = (0, import_react44.createContext)(void 0);
function useModalContext() {
  const context = (0, import_react44.useContext)(ModalContext);
  if (!context) {
...
var ModalHeader = ({
  ...
  const innerHeaderId = (0, import_react45.useId)();
...
// node_modules/flowbite-react/dist/esm/components/Modal/Modal.mjs
var ModalComponent = (0, import_react47.forwardRef)(
  ({
    children,
    className,
    dismissible = false,
    ...
    const [headerId, setHeaderId] = (0, import_react47.useState)(void 0);
...
function Popover({
  ...
  const [uncontrolledOpen, setUncontrolledOpen] = (0, import_react49.useState)(Boolean(initialOpen));
  ...
  const target = (0, import_react49.useMemo)(() => {
    return (0, import_react49.cloneElement)(
      children,
      getReferenceProps({
        ref,
...
var Radio = (0, import_react51.forwardRef)(
...
var RangeSlider = (0, import_react52.forwardRef)(
...
var RatingContext = (0, import_react53.createContext)(void 0);
function useRatingContext() {
  const context = (0, import_react53.useContext)(RatingContext);
  if (!context) {
...
var SidebarContext = (0, import_react55.createContext)(void 0);
function useSidebarContext() {
  const context = (0, import_react55.useContext)(SidebarContext);
  if (!context) {
...
var SidebarItemContext = (0, import_react56.createContext)(void 0);
function useSidebarItemContext() {
  const context = (0, import_react56.useContext)(SidebarItemContext);
  if (!context) {
...
var SidebarCollapse = ({
  ...
  const [isOpen, setOpen] = (0, import_react57.useState)(open);
  const { theme: rootTheme, isCollapsed } = useSidebarContext();
  const theme2 = mergeDeep(rootTheme.collapse, customTheme);
  (0, import_react57.useEffect)(() => setOpen(open), [open]);
...
var SidebarItem = (0, import_react58.forwardRef)(
  ({
    active: isActive,
    as: Component = "a",
    children,
...
var TableBodyContext = (0, import_react60.createContext)(void 0);
function useTableBodyContext() {
  const context = (0, import_react60.useContext)(TableBodyContext);
  if (!context) {
...
var TableContext = (0, import_react61.createContext)(void 0);
function useTableContext() {
  const context = (0, import_react61.useContext)(TableContext);
  if (!context) {
...
// node_modules/flowbite-react/dist/esm/components/Table/TableBody.mjs
var TableBody = (0, import_react62.forwardRef)(
...
var TableCell = (0, import_react63.forwardRef)(
  ({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
var TableHeadContext = (0, import_react64.createContext)(void 0);
function useTableHeadContext() {
  const context = (0, import_react64.useContext)(TableHeadContext);
  if (!context) {
...
// node_modules/flowbite-react/dist/esm/components/Table/TableHead.mjs
var TableHead = (0, import_react65.forwardRef)(
  ({ children, className, theme: customTheme = {}, ...props }, ref) => {
    const { theme: rootTheme } = useTableContext();
...
var TableHeadCell = (0, import_react66.forwardRef)(
  ({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
var TableRow = (0, import_react67.forwardRef)(
  ({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
// node_modules/flowbite-react/dist/esm/components/Table/Table.mjs
var TableComponent = (0, import_react68.forwardRef)(
...
var TabsComponent = (0, import_react69.forwardRef)(
  ({ children, className, onActiveTabChange, variant = "default", theme: customTheme = {}, ...props }, ref) => {
    ...
    const tabs = (0, import_react69.useMemo)(
      () => import_react69.Children.map(
        import_react69.Children.toArray(children),
        ({ props: props2 }) => props2
      ),
      [children]
    );
    const tabRefs = (0, import_react69.useRef)([]);
    const [activeTab, setActiveTab] = (0, import_react69.useState)(
      Math.max(
        0,
        tabs.findIndex((tab) => tab.active)
      )
    );
    const [focusedTab, setFocusedTab] = (0, import_react69.useState)(-1);
...
var TimelineContentContext = (0, import_react71.createContext)(void 0);
function useTimelineContentContext() {
  const context = (0, import_react71.useContext)(TimelineContentContext);
  if (!context) {
...
var TimelineContext = (0, import_react72.createContext)(void 0);
function useTimelineContext() {
  const context = (0, import_react72.useContext)(TimelineContext);
  if (!context) {
...
var TimelineItemContext = (0, import_react73.createContext)(void 0);
function useTimelineItemContext() {
  const context = (0, import_react73.useContext)(TimelineItemContext);
  if (!context) {
...
var ToastContext = (0, import_react74.createContext)(void 0);
function useToastContext() {
  const context = (0, import_react74.useContext)(ToastContext);
  if (!context) {
...
var ToastComponent = ({ children, className, duration = 300, theme: customTheme = {}, ...props }) => {
  const [isClosed, setIsClosed] = (0, import_react75.useState)(false);
  const [isRemoved, setIsRemoved] = (0, import_react75.useState)(false);
...
var ToggleSwitch = (0, import_react76.forwardRef)(
  ({
    checked,
    className,
    color = "blue",
